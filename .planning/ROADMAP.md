...
- [ ] 06-02: Implement `BgeM3Embedder` (loads int8 ONNX, mean pooling + L2 normalize; warm-up call on cold start to amortize JIT) and `MlNetClassifier` adapters; first-run dummy 1024-dim model generator; replace placeholder `applyML`
