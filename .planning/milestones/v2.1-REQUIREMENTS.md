# Requirements Archive: v2.1 Hermes-less Session Tiering

**Archived:** 2026-05-12
**Status:** ✅ SHIPPED

This is the archived requirements specification for v2.1. For current requirements (next milestone), see `.planning/REQUIREMENTS.md` (created fresh after `/gsd:new-milestone`). All 24 v2.1 requirements (HSP-01..04, CFP-01..04, TIER-01..05, OBS-01, MIG-01..06, DOC-01..04) shipped and verified.

**Milestone Summary:**
- **Shipped:** 24 of 24 v2.1 requirements (100%)
- **Adjusted:** None
- **Dropped:** None
- **Gap closure:** TD-1 (no formal REQ-ID; strengthens TIER-04 from structural to executable assertion via TC-7) closed by Phase 24 commit `cc5592d`
